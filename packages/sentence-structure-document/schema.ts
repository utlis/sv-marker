...
export const allowedSentenceElementNameOptions = {
  "core-sentence-element": ["S", "V", "O", "C"] satisfies SentenceElementName[],
  "sentence-constituent": {
    "verbal-phrase": {
      nominal: ["S", "O", "C"] satisfies SentenceElementName[],
      adjectival: ["C", "M"] satisfies SentenceElementName[],
      adverbial: ["M"] satisfies SentenceElementName[],
    },
    clause: {
      nominal: ["S", "O", "C"] satisfies SentenceElementName[],
      adjectival: ["M"] satisfies SentenceElementName[],
      adverbial: ["M", "C"] satisfies SentenceElementName[],
    },
    "modifier-phrase": ["M"] satisfies SentenceElementName[],
  },
};
...
const SentenceStructureElementSchema = z.union([
  z.object({
    ...
    sentenceElementName: z.nullable(
      z.literal(allowedSentenceElementNameOptions["core-sentence-element"]),
    ),
  }),
  z.object({
    kind: z.literal("sentence-constituent"),
    type: z.literal("verbal-phrase"),
    usage: z.literal("nominal"),
    id: z.uuid(),
    startWordId: z.uuid(),
    endWordId: z.uuid(),
    sentenceElementName: z.nullable(
      z.literal(
        allowedSentenceElementNameOptions["sentence-constituent"][
          "verbal-phrase"
        ]["nominal"],
      ),
    ),
  ...
  z.object({
    ...
    sentenceElementName: z.nullable(
      z.literal(
        allowedSentenceElementNameOptions["sentence-constituent"]["clause"][
          "nominal"
        ],
      ),
    ),
  ...
  z.object({
    kind: z.literal("sentence-constituent"),
    type: z.literal("modifier-phrase"),
    id: z.uuid(),
    startWordId: z.uuid(),
    endWordId: z.uuid(),
    sentenceElementName: z.nullable(
...
const SentenceSchema = z
  ...
  .refine(
            ...
            .every((otherSentenceStructureElement) => {
              ...
              return !(
                sentenceStructureElement.kind ===
                  otherSentenceStructureElement.kind &&
    ...
    {
      error: "区分と開始・終了位置が同じ文構造要素が複数存在します。",
    },
  )
  .refine(
    (sentence) => {
